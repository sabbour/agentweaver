...
- If yes → run `.copilot/skills/agentweaver-docs-feature/SKILL.md` or `.copilot/skills/agentweaver-docs-sync/SKILL.md` after the fix lands
...
- New UI / workflow → use `.copilot/skills/agentweaver-docs-feature/SKILL.md`
- Existing behavior now works differently → use `.copilot/skills/agentweaver-docs-sync/SKILL.md`
...
- If yes → use `.copilot/skills/agentweaver-docs-sync/SKILL.md` to update affected pages
...
## Docs disposition
Use `.copilot/skills/agentweaver-docs-feature/SKILL.md` to add new content, or `.copilot/skills/agentweaver-docs-sync/SKILL.md` to correct drifted content.
