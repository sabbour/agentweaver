---
name: "agentweaver-azure-fluent-system-sync"
...
```powershell
rg -n "transient-output markers|machine-local path markers" apps/web/src/copilot-fluent-system .copilot/skills/agentweaver-azure-fluent-system-sync
git --no-pager diff --check -- apps/web/src/copilot-fluent-system .copilot/skills/agentweaver-azure-fluent-system-sync
```
