...
public class RepositoryRootValidatorTests
{
    ...
    public async Task Integration_allowlist_rejects_outside_path()
    {
        ...
        try
        {
            await using var factory = new ScaffolderWebApplicationFactory()
            ...
            client.DefaultRequestHeaders.Add("Authorization", $"Bearer {ScaffolderWebApplicationFactory.TestApiKey}");
