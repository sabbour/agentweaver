...
/// </summary>
public sealed class WorkspacePathValidationTests : IClassFixture<ScaffolderWebApplicationFactory>
{
    private readonly ScaffolderWebApplicationFactory _factory;
    private readonly HttpClient _client;

    public WorkspacePathValidationTests(ScaffolderWebApplicationFactory factory)
    {
        _factory = factory;
        _client  = factory.CreateClient();
        _client.DefaultRequestHeaders.Authorization =
            new System.Net.Http.Headers.AuthenticationHeaderValue(
                "Bearer", ScaffolderWebApplicationFactory.TestApiKey);
    }
