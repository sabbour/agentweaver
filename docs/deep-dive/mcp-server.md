...
| GitHub auth helpers | Help clients inspect GitHub sign-in state, enumerate reachable GitHub accounts/repos, or start GitHub sign-in where Agentweaver exposes that flow. | `github_status`, `github_accounts_list`, `github_repos_list`, `github_signin`, `github_signout` |
