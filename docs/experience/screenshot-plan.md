...
| 8 | `create-from-github-dialog.png` | `projects.md` | `/projects` | Click **Create from GitHub** | **Create project from GitHub** dialog: **Name**, repository search/recent/orgs/paste controls, auto-filled **Repository folder**, and the **Suggested** / **Templates** / **Generate** blueprint tabs; or **Connect GitHub** when unauthenticated. |
