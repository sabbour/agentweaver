...
- Durable event log: `native:database` (`shape=cylinder`); Agentweaver Fluent card chrome.

- Cursor subscriber: `native:uml` (`shape=component`); Agentweaver Fluent card chrome.
...
handoff | role0 | role1 | batch | evidence direction; intended shape attachment; orthogonal gutter or horizontal activation-to-activation; crossing bridges where required | clean
