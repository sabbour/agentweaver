...
- Plan & execute: `native:flowchart` (`shape=mxgraph.flowchart.process`); Agentweaver Fluent card chrome.

- Review & finish: `native:flowchart` (`shape=mxgraph.flowchart.process`); Agentweaver Fluent card chrome.
...
handoff | role0 | role1 | assemble | evidence direction; intended shape attachment; orthogonal gutter or horizontal activation-to-activation; crossing bridges where required | clean
