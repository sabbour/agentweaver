...
Pass 2 corrected product-symbol size/orientation. Snake reading order remains left-to-right across planning, down the outer gutter, then right-to-left through integration, collective review and finishing.
...
Pitch 1676 → pass 1 23373
= 13.945704x. Later passes preserve that hierarchy.
