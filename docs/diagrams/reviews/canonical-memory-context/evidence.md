# canonical-memory-context: evidence and exclusive claim
...
Target page: `docs/deep-dive/memory-decisions.md`
...
- n0 **Active decisions** — `custom:agentweaver`; apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:54-63,154-176
- n1 **Core + learnings** — `native:database`; apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:65-89
- n2 **Open session** — `custom:agentweaver`; apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:94-104
- n3 **Joint rank + budget** — `native:flowchart`; apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:107-140
- n4 **Context compiler** — `custom:agentweaver`; apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:101-104,179-213
- n5 **Untrusted JSON** — `native:flowchart`; apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:185-225

## Every connector's evidence map
- e0: n1 → n3: combine / sort. Evidence: apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:65-89; apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:107-140
- e1: n0 → n4: approved. Evidence: apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:54-63,154-176; apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:101-104,179-213
- e2: n2 → n4: latest open. Evidence: apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:94-104; apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:101-104,179-213
- e3: n3 → n4: selected. Evidence: apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:107-140; apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:101-104,179-213
- e4: n4 → n5: serialize. Evidence: apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:101-104,179-213; apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:185-225
