...
Opened `canonical-memory-context-pass-02.png` (2× official draw.io export) and `canonical-memory-context-pass-02-print.png` (100-units/inch A5 inspection page).
