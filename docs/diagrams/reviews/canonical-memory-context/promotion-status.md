# canonical-memory-context: review candidate, NOT canonically promoted

## Completed and verified
- Preserved editable pitch and four independently exported/inspected passes. Final candidate: `canonical-memory-context-pass-04.drawio` / `canonical-memory-context-pass-04.png`.
...
- Semantic pass-1 growth: 9.235120×; no invisible, off-page, duplicated or metadata-padding cells.
- Final 5 arrows individually traced in `canonical-memory-context-pass-04.md`; XML endpoints agree with the trace.
...
- No write to `docs/diagrams/src/canonical-memory-context.drawio`, `docs/diagrams/canonical-memory-context.png`, or the stable hash.
