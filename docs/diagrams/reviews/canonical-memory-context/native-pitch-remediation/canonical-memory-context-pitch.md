# canonical-memory-context: native Fluent responsibility pitch

Audience: Agentweaver documentation readers. Takeaway: Approved decisions, jointly ranked memories and the open session converge into untrusted JSON.

Target page: `docs/deep-dive/memory-decisions.md`. Stable image: `docs/diagrams/canonical-memory-context.png`.
...
- Active decisions: `apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:54-63,154-176`
- Core + learnings: `apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:65-89`
- Open session: `apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:94-104`
- Joint rank + budget: `apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:107-140`
- Context compiler: `apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:101-104,179-213`
- Untrusted JSON: `apps/Agentweaver.Api/Memory/MemoryContextCompiler.cs:185-225`
