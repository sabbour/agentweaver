...
Remaining orientation defects: 0; overlap/label-legibility defects: 3; arrow defects: 3.

Official UTF-8 XML measurement: 2197 → 25426 (11.573054×), metric `visible-semantic-canonical-xml-v1`. Even excluding all three source/evidence panels, growth remains 9.958125×; no need for those panels, duplicate objects, hidden cells, metadata, embedded-image bytes or off-page padding to meet the gate.
