...
The lean native-symbol pitch preserves the grounded graph. It is not publishable: outcome labels compete in narrow gutters, return arrowheads bunch at shared destinations, and card/type/badge/source hierarchy is missing. These visible defects are handed to pass one.
