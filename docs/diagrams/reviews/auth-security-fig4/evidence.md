# auth-security-fig4: evidence and exclusive claim
...
- n0 **External MCP client** — `native:uml`; docs/deep-dive/auth-security.md:25-31; apps/Agentweaver.Api/Endpoints/OAuthAuthorizationServerEndpoints.cs
- n1 **Authorization server** — `native:flowchart`; apps/Agentweaver.Api/Endpoints/OAuthAuthorizationServerEndpoints.cs; docs/deep-dive/auth-security.md:25-31
- n2 **Assistant API** — `custom:agentweaver`; apps/Agentweaver.Api/Auth/OAuth/OperatorAssistantBrokerTokenIssuer.cs; apps/Agentweaver.Api/Assistant/AssistantRunService.cs:789-813
- n3 **MCP validation** — `native:flowchart`; apps/Agentweaver.Mcp/McpBrokerAuthenticationHandler.cs:40-85
- n4 **API broker handler** — `native:flowchart`; apps/Agentweaver.Api/Auth/AgentweaverAuthentication.cs:45-49; 194-250
- n5 **Resource authorization** — `native:flowchart`; docs/deep-dive/auth-security.md:29-31; apps/Agentweaver.Api/Security

## Every connector's evidence map
- e0: n0 → n1: OAuth exchange. Evidence: docs/deep-dive/auth-security.md:25-31; apps/Agentweaver.Api/Endpoints/OAuthAuthorizationServerEndpoints.cs; apps/Agentweaver.Api/Endpoints/OAuthAuthorizationServerEndpoints.cs; docs/deep-dive/auth-security.md:25-31
- e1: n1 → n3: broker token. Evidence: apps/Agentweaver.Api/Endpoints/OAuthAuthorizationServerEndpoints.cs; docs/deep-dive/auth-security.md:25-31; apps/Agentweaver.Mcp/McpBrokerAuthenticationHandler.cs:40-85
- e2: n2 → n3: turn broker. Evidence: apps/Agentweaver.Api/Auth/OAuth/OperatorAssistantBrokerTokenIssuer.cs; apps/Agentweaver.Api/Assistant/AssistantRunService.cs:789-813; apps/Agentweaver.Mcp/McpBrokerAuthenticationHandler.cs:40-85
- e3: n3 → n4: forward broker. Evidence: apps/Agentweaver.Mcp/McpBrokerAuthenticationHandler.cs:40-85; apps/Agentweaver.Api/Auth/AgentweaverAuthentication.cs:45-49; 194-250
- e4: n4 → n5: authorize. Evidence: apps/Agentweaver.Api/Auth/AgentweaverAuthentication.cs:45-49; 194-250; docs/deep-dive/auth-security.md:29-31; apps/Agentweaver.Api/Security
