# auth-security-fig4 — pitch

Mode: Initial pitch (not publishable)

## Actual PNG inspection
Opened `auth-security-fig4-pitch.png` (2× official draw.io export) and `auth-security-fig4-pitch-print.png` (100-units/inch A5 inspection page).
...
## Findings / changes
Readable issuer → MCP → API chain. Expand external and assistant issuance, strict token checks, and independent authorization.
