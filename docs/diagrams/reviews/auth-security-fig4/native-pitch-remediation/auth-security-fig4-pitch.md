# auth-security-fig4: native Fluent responsibility pitch

Audience: Agentweaver documentation readers. Takeaway: OAuth and assistant turns obtain Agentweaver broker tokens; MCP and API validate independently.

Target page: `docs/deep-dive/auth-security.md`. Stable image: `docs/diagrams/auth-security-fig4.png`.
...
- External MCP client: `docs/deep-dive/auth-security.md:25-31; apps/Agentweaver.Api/Endpoints/OAuthAuthorizationServerEndpoints.cs`
- Authorization server: `apps/Agentweaver.Api/Endpoints/OAuthAuthorizationServerEndpoints.cs; docs/deep-dive/auth-security.md:25-31`
- Assistant API: `apps/Agentweaver.Api/Auth/OAuth/OperatorAssistantBrokerTokenIssuer.cs; apps/Agentweaver.Api/Assistant/AssistantRunService.cs:789-813`
- MCP validation: `apps/Agentweaver.Mcp/McpBrokerAuthenticationHandler.cs:40-85`
- API broker handler: `apps/Agentweaver.Api/Auth/AgentweaverAuthentication.cs:45-49; 194-250`
- Resource authorization: `docs/deep-dive/auth-security.md:29-31; apps/Agentweaver.Api/Security`
