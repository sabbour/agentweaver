# auth-security-fig4: review candidate, NOT canonically promoted

## Completed and verified
- Preserved editable pitch and four independently exported/inspected passes. Final candidate: `auth-security-fig4-pass-04.drawio` / `auth-security-fig4-pass-04.png`.
...
- Semantic pass-1 growth: 9.239121×; no invisible, off-page, duplicated or metadata-padding cells.
- Final 5 arrows individually traced in `auth-security-fig4-pass-04.md`; XML endpoints agree with the trace.
...
- No write to `docs/diagrams/src/auth-security-fig4.drawio`, `docs/diagrams/auth-security-fig4.png`, or the stable hash.
