# canonical-durable-event-stream-sequence — pitch
...
- Producer: `native:uml` (`shape=component`); Agentweaver Fluent card chrome.

- EF / Postgres: `native:database` (`shape=cylinder`); Agentweaver Fluent card chrome.
...
request | activation0-0 | activation1-0 | append event | evidence direction; intended shape attachment; orthogonal gutter or horizontal activation-to-activation; crossing bridges where required | clean

response | activation1-1 | activation0-1 | committed sequence | evidence direction; intended shape attachment; orthogonal gutter or horizontal activation-to-activation; crossing bridges where required | clean
