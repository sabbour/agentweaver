...
Metric: `visible-semantic-canonical-xml-v1`. Baseline **4277**; result **47258**; growth **11.049334×**. No invisible, off-page, duplicate or metadata-padding cells; see `growth.json`.
