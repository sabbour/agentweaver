# canonical-workflow-selection — pass-03
...
Correction-only inspection of the newly exported PNG and print derivative found no remaining orientation, overlap, glyph clipping, label collision or arrow endpoint defect. All side labels precede the rail lanes; return labels remain on dashed marigold outer paths. The explicit two-line 2 / unusable label now clears its own connector; candidate-count, exception, retry and fallback paths remain unchanged.
