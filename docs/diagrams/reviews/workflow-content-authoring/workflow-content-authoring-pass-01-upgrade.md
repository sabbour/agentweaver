...
Metric: `visible-semantic-canonical-xml-v1`. Baseline **3556**; result **37036**; growth **10.415073×**. No invisible, off-page, duplicate or metadata-padding cells; see `growth.json`.
