# assistant-runtime-fig1 — pitch

Mode: Initial pitch (not publishable)

## Actual PNG inspection
Opened `assistant-runtime-fig1-pitch.png` (2× official draw.io export) and `assistant-runtime-fig1-pitch-print.png` (100-units/inch A5 inspection page).
...
## Findings / changes
Readable UI → API → held pod overview. Missing durable history, MCP/SDK separation and idle/terminal distinction.
