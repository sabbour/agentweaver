...
Official UTF-8 XML measurement: 2161 → 25985 (12.024526×), metric `visible-semantic-canonical-xml-v1`. Even excluding all three source/evidence panels, growth remains 10.401666×; no need for those panels, duplicate objects, hidden cells, metadata, embedded-image bytes or off-page padding to meet the gate.
