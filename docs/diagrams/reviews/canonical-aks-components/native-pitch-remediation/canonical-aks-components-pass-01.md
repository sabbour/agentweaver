# canonical-aks-components — pass 01
...
Official UTF-8 XML measurement: 2211 → 25227 (11.409769×), metric `visible-semantic-canonical-xml-v1`. Even excluding all three source/evidence panels, growth remains 9.826775×; no need for those panels, duplicate objects, hidden cells, metadata, embedded-image bytes or off-page padding to meet the gate.
