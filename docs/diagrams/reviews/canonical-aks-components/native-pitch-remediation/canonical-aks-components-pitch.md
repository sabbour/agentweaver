# canonical-aks-components: native Fluent responsibility pitch

Audience: Agentweaver documentation readers. Takeaway: Replicated API and workers share durable services; AgentHost pods execute isolated turns.

Target page: `docs/aks-deployment.md`. Stable image: `docs/diagrams/canonical-aks-components.png`.
...
- Application ingress: `k8s/base/frontend-deployment.yaml:10; k8s/base/gateway.yaml; k8s/base/gateway-preview.yaml`
- API deployment: `k8s/base/api-deployment.yaml:13,67-72,415-419`
- MCP deployment: `k8s/base/mcp-deployment.yaml:10; apps/Agentweaver.Mcp/McpBrokerAuthenticationHandler.cs`
- Worker deployment: `k8s/base/worker-deployment.yaml:13,67-72,266-270; k8s/base/worker-hpa.yaml:65-66`
- AgentHost pods: `k8s/base/sandbox-warmpool-agenthost.yaml; apps/Agentweaver.AgentHost/Program.cs:232-285`
- Durable services: `k8s/base/api-deployment.yaml:67-72,415-419; k8s/base/pvc-workspace.yaml; k8s/base/worker-deployment.yaml:266-270`
