# canonical-aks-components: review candidate, NOT canonically promoted

## Completed and verified
- Preserved editable pitch and four independently exported/inspected passes. Final candidate: `canonical-aks-components-pass-04.drawio` / `canonical-aks-components-pass-04.png`.
...
- Semantic pass-1 growth: 9.262733×; no invisible, off-page, duplicated or metadata-padding cells.
- Final 5 arrows individually traced in `canonical-aks-components-pass-04.md`; XML endpoints agree with the trace.
...
- No write to `docs/diagrams/src/canonical-aks-components.drawio`, `docs/diagrams/canonical-aks-components.png`, or the stable hash.
