...
- Agentweaver.Api: `native:uml` (`shape=component`); Agentweaver Fluent card chrome.

- AgentRuntime: `native:uml` (`shape=component`); Agentweaver Fluent card chrome.
...
handoff | role0 | role1 | references | evidence direction; intended shape attachment; orthogonal gutter or horizontal activation-to-activation; crossing bridges where required | clean
