...
Canonical source: `docs/diagrams/src/email-components.drawio`.
Stable PNG: `docs/diagrams/email-components.png`.
...
- `api`: native:uml — Agentweaver.Api.
- `host`: native:uml — Agentweaver.AgentHost.
- `mcp`: native:uml — Agentweaver.Mcp.
- `runtime`: native:uml — AgentRuntime.
- `tools`: native:uml — AgentTools.
- `domain`: native:uml — Domain.
