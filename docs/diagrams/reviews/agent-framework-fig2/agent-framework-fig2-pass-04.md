# Coordinator · MAF hands off to services — pass-04
...
- `outcome-to-dispatch` | outcome | dispatch | eligible handoff | apps/Agentweaver.Api/Coordinator/CoordinatorRunService.cs:1172-1250 | source→target block arrowhead | endpoints on intended card | orthogonal route checked in opened PNG | clean
- `outcome-to-release` | outcome | release | release after handoff | apps/Agentweaver.Api/Coordinator/CoordinatorRunService.cs:1172-1250 | source→target block arrowhead | endpoints on intended card | orthogonal route checked in opened PNG | clean
- `dispatch-to-services` | dispatch | services | start services | apps/Agentweaver.Api/Coordinator/CoordinatorRunService.cs:1172-1250 | source→target block arrowhead | endpoints on intended card | orthogonal route checked in opened PNG | clean
- `services-to-records` | services | records | persist phase | apps/Agentweaver.Api/Coordinator/CoordinatorRunService.cs:1172-1250 | source→target block arrowhead | endpoints on intended card | orthogonal route checked in opened PNG | clean
- `services-to-executors` | services | executors | invoke directly | apps/Agentweaver.Api/Coordinator/CollectiveAssemblyPipeline.cs:132-169,327,499 | source→target block arrowhead | endpoints on intended card | orthogonal route checked in opened PNG | clean
- `records-to-restart` | records | restart | persisted phase | apps/Agentweaver.Api/Coordinator/CoordinatorRunService.cs:1172-1250 | source→target block arrowhead | endpoints on intended card | orthogonal route checked in opened PNG | clean
- `executors-to-gate` | executors | gate | service review | apps/Agentweaver.Api/Coordinator/AssemblyReviewGate.cs:6-44 | source→target block arrowhead | endpoints on intended card | orthogonal route checked in opened PNG | clean
- `restart-to-services` | restart | services | re-arm driver | apps/Agentweaver.Api/Coordinator/CoordinatorRunService.cs:1172-1250 | source→target block arrowhead | endpoints on intended card | orthogonal route checked in opened PNG | clean
