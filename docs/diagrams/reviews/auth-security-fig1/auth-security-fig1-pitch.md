# auth-security-fig1 — pitch

Mode: Initial pitch (not publishable)

## Actual PNG inspection
Opened `auth-security-fig1-pitch.png` (2× official draw.io export) and `auth-security-fig1-pitch-print.png` (100-units/inch A5 inspection page).
...
## Findings / changes
Readable conceptual request overview, but selector → operation is too compressed: expose authentication and resource authorization as separate checks.
