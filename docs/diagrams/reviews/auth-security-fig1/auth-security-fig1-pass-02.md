# auth-security-fig1 — pass-02

Mode: correction-only

## Actual PNG inspection
Opened `auth-security-fig1-pass-02.png` (2× official draw.io export) and `auth-security-fig1-pass-02-print.png` (100-units/inch A5 inspection page).
