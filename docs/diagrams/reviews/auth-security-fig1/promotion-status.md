# auth-security-fig1: review candidate, NOT canonically promoted

## Completed and verified
- Preserved editable pitch and four independently exported/inspected passes. Final candidate: `auth-security-fig1-pass-04.drawio` / `auth-security-fig1-pass-04.png`.
...
- Semantic pass-1 growth: 9.551505×; no invisible, off-page, duplicated or metadata-padding cells.
- Final 6 arrows individually traced in `auth-security-fig1-pass-04.md`; XML endpoints agree with the trace.
...
- No write to `docs/diagrams/src/auth-security-fig1.drawio`, `docs/diagrams/auth-security-fig1.png`, or the stable hash.
