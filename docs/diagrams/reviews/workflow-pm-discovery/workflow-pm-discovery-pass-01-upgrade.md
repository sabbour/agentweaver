...
Metric: `visible-semantic-canonical-xml-v1`. Baseline **2159**; result **24410**; growth **11.30616×**. No invisible, off-page, duplicate or metadata-padding cells; see `growth.json`.
