# AKS network: two ingress planes: pitch review
...
images as truth. Actual `canonical-aks-network-pitch.png` and its half-size `-pitch-print.png`
...
is the source. Pass 1 growth: 2344 ->
33003 = 14.079778x; see `growth.json`.
