...
Canonical source: `docs/diagrams/src/canonical-board-lifecycle.drawio`.
Stable PNG: `docs/diagrams/canonical-board-lifecycle.png`.
...
- `backlog`: native:flowchart — Backlog.
- `ready`: native:flowchart — Ready.
- `progress`: native:flowchart — Active.
- `failed`: native:flowchart — Problems.
- `review`: native:flowchart — Human Review.
- `done`: native:flowchart — Done.
