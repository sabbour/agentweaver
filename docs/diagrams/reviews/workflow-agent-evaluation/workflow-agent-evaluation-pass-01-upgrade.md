...
Metric: `visible-semantic-canonical-xml-v1`. Baseline **2721**; result **29383**; growth **10.798603×**. No invisible, off-page, duplicate or metadata-padding cells; see `growth.json`.
