...
Metric: `visible-semantic-canonical-xml-v1`. Baseline **5129**; result **49898**; growth **9.728602×**. No invisible, off-page, duplicate or metadata-padding cells; see `growth.json`.
