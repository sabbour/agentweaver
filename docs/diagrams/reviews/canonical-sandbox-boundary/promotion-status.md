# canonical-sandbox-boundary: review candidate, NOT canonically promoted

## Completed and verified
- Preserved editable pitch and four independently exported/inspected passes. Final candidate: `canonical-sandbox-boundary-pass-04.drawio` / `canonical-sandbox-boundary-pass-04.png`.
...
- Semantic pass-1 growth: 9.226256×; no invisible, off-page, duplicated or metadata-padding cells.
- Final 5 arrows individually traced in `canonical-sandbox-boundary-pass-04.md`; XML endpoints agree with the trace.
...
- No write to `docs/diagrams/src/canonical-sandbox-boundary.drawio`, `docs/diagrams/canonical-sandbox-boundary.png`, or the stable hash.
