# canonical-sandbox-boundary: evidence and exclusive claim
...
Target page: `docs/deep-dive/sandbox.md`
...
- n0 **Model tool request** — `native:flowchart`; packages/Agentweaver.AgentRuntime/CopilotAIAgent.cs:1850-1920,2079-2139
- n1 **Governance** — `native:flowchart`; packages/Agentweaver.AgentRuntime/SandboxGovernance.cs:114-162
- n2 **Registered tools** — `native:flowchart`; packages/Agentweaver.AgentRuntime/SandboxGovernance.cs; packages/Agentweaver.AgentTools/Tools/RunCommandTool.cs
- n3 **Workspace boundary** — `native:flowchart`; packages/Agentweaver.SandboxFs; docs/deep-dive/sandbox.md:72-110
- n4 **Execution boundary** — `native:kubernetes`; apps/Agentweaver.Api/Sandbox/SandboxExecutorRouter.cs; docs/deep-dive/sandboxed-execution.md:20-40
- n5 **Credential handling** — `native:flowchart`; apps/Agentweaver.AgentHost/AgentHostRuntimeState.cs:92-95,172-174; packages/Agentweaver.AgentRuntime/CopilotAIAgent.cs:446-453; docs/deep-dive/sandboxed-execution.md:113-130

## Every connector's evidence map
- e0: n0 → n1: governed calls. Evidence: packages/Agentweaver.AgentRuntime/CopilotAIAgent.cs:1850-1920,2079-2139; packages/Agentweaver.AgentRuntime/SandboxGovernance.cs:114-162
- e1: n1 → n2: both allow. Evidence: packages/Agentweaver.AgentRuntime/SandboxGovernance.cs:114-162; packages/Agentweaver.AgentRuntime/SandboxGovernance.cs; packages/Agentweaver.AgentTools/Tools/RunCommandTool.cs
- e2: n2 → n3: file operation. Evidence: packages/Agentweaver.AgentRuntime/SandboxGovernance.cs; packages/Agentweaver.AgentTools/Tools/RunCommandTool.cs; packages/Agentweaver.SandboxFs; docs/deep-dive/sandbox.md:72-110
- e3: n2 → n4: run_command. Evidence: packages/Agentweaver.AgentRuntime/SandboxGovernance.cs; packages/Agentweaver.AgentTools/Tools/RunCommandTool.cs; apps/Agentweaver.Api/Sandbox/SandboxExecutorRouter.cs; docs/deep-dive/sandboxed-execution.md:20-40
- e4: n4 → n5: eligible git / gh. Evidence: apps/Agentweaver.Api/Sandbox/SandboxExecutorRouter.cs; docs/deep-dive/sandboxed-execution.md:20-40; apps/Agentweaver.AgentHost/AgentHostRuntimeState.cs:92-95,172-174; packages/Agentweaver.AgentRuntime/CopilotAIAgent.cs:446-453; docs/deep-dive/sandboxed-execution.md:113-130
