# canonical-sandbox-boundary: native Fluent responsibility pitch

Audience: Agentweaver documentation readers. Takeaway: Native shell is denied; governed tools combine AGT policy, direct containment and execution isolation.

Target page: `docs/deep-dive/sandbox.md`. Stable image: `docs/diagrams/canonical-sandbox-boundary.png`.
...
- Model tool request: `packages/Agentweaver.AgentRuntime/CopilotAIAgent.cs:1850-1920,2079-2139`
- Governance: `packages/Agentweaver.AgentRuntime/SandboxGovernance.cs:114-162`
- Registered tools: `packages/Agentweaver.AgentRuntime/SandboxGovernance.cs; packages/Agentweaver.AgentTools/Tools/RunCommandTool.cs`
- Workspace boundary: `packages/Agentweaver.SandboxFs; docs/deep-dive/sandbox.md:72-110`
- Execution boundary: `apps/Agentweaver.Api/Sandbox/SandboxExecutorRouter.cs; docs/deep-dive/sandboxed-execution.md:20-40`
- Credential handling: `apps/Agentweaver.AgentHost/AgentHostRuntimeState.cs:92-95,172-174; packages/Agentweaver.AgentRuntime/CopilotAIAgent.cs:446-453; docs/deep-dive/sandboxed-execution.md:113-130`
