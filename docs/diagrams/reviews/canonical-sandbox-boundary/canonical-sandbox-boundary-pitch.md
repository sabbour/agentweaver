# canonical-sandbox-boundary — pitch

Mode: Initial pitch (not publishable)

## Actual PNG inspection
Opened `canonical-sandbox-boundary-pitch.png` (2× official draw.io export) and `canonical-sandbox-boundary-pitch-print.png` (100-units/inch A5 inspection page).
...
## Findings / changes
Readable model → governance → execution overview. Expand direct containment, point-of-use validation, exceptions and current credential discrepancy.
