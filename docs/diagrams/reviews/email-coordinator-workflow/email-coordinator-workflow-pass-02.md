...
Pass 2 corrected product-symbol proportions. The sequence retains five lifelines, explicit activation endpoints, chronological horizontal messages and native bridge arcs where messages cross uninvolved lifelines.
