...
Canonical source: `docs/diagrams/src/email-coordinator-workflow.drawio`.
Stable PNG: `docs/diagrams/email-coordinator-workflow.png`.
...
- `human`: native:uml — Human.
- `coord`: custom:agentweaver — Coordinator.
- `children`: custom:agentweaver — Children.
- `assembly`: custom:agentweaver — Assembly.
- `scribe`: custom:agentweaver — Git / Scribe.
