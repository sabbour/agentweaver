# experience-operations-fig1: pass-02

**Takeaway:** Inspection and configuration have different scopes; MCP parity is intentionally partial.
...
- Diagnostics: `native:flowchart`.
- Heartbeat + Flow: `custom:agentweaver`.
- Cluster + traces: `native:flowchart`.
- Account settings: `native:c4`.
- Platform settings: `native:flowchart`.
- Project settings: `custom:agentweaver`.
...
No arrows: this is a scoped surface map, not a process. Final trace set is empty.
