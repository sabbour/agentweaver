...
Remaining orientation defects: 0; overlap/label-legibility defects: 3; arrow defects: 1.

Official UTF-8 XML measurement: 2185 → 25381 (11.616018×), metric `visible-semantic-canonical-xml-v1`. Even excluding all three source/evidence panels, growth remains 9.999085×; no need for those panels, duplicate objects, hidden cells, metadata, embedded-image bytes or off-page padding to meet the gate.
