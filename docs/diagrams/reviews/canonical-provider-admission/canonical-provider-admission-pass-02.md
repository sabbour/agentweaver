...
Opened `canonical-provider-admission-pass-02.png` (2× official draw.io export) and `canonical-provider-admission-pass-02-print.png` (100-units/inch A5 inspection page).
