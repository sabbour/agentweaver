# canonical-provider-admission: evidence and exclusive claim
...
- n0 **Prepare context** — `native:flowchart`; apps/Agentweaver.Api/Auth/AiExecutionPlanService.cs:205-207,256-290
- n1 **Accept request** — `native:flowchart`; apps/Agentweaver.Api/Auth/AiExecutionPlanService.cs:293-358
- n2 **Accepted plan** — `custom:agentweaver`; apps/Agentweaver.Api/Auth/AiExecutionPlanService.cs:121-183; apps/Agentweaver.Api/Auth/EffectiveModelProviderResolver.cs
- n3 **Run snapshot** — `native:database`; apps/Agentweaver.Api/Auth/RunModelProviderSnapshotStore.cs:45-77,83-155; apps/Agentweaver.Api/Runs/RunOrchestrator.cs:796-825
- n4 **Invocation guard** — `native:flowchart`; apps/Agentweaver.Api/Auth/RunModelInvocationGuard.cs:11-48; apps/Agentweaver.Api/Runs/RunOrchestrator.cs:826-855
- n5 **Capability fences** — `native:flowchart`; apps/Agentweaver.Api/Auth/GitHubCapabilityBroker.cs:35-123; apps/Agentweaver.Api/Sandbox/RunGitHubCapabilityCredentialProvider.cs

## Every connector's evidence map
- e0: n0 → n1: signed context. Evidence: apps/Agentweaver.Api/Auth/AiExecutionPlanService.cs:205-207,256-290; apps/Agentweaver.Api/Auth/AiExecutionPlanService.cs:293-358
- e1: n1 → n2: match. Evidence: apps/Agentweaver.Api/Auth/AiExecutionPlanService.cs:293-358; apps/Agentweaver.Api/Auth/AiExecutionPlanService.cs:121-183; apps/Agentweaver.Api/Auth/EffectiveModelProviderResolver.cs
- e2: n2 → n3: capture. Evidence: apps/Agentweaver.Api/Auth/AiExecutionPlanService.cs:121-183; apps/Agentweaver.Api/Auth/EffectiveModelProviderResolver.cs; apps/Agentweaver.Api/Auth/RunModelProviderSnapshotStore.cs:45-77,83-155; apps/Agentweaver.Api/Runs/RunOrchestrator.cs:796-825
- e3: n3 → n4: load boundary. Evidence: apps/Agentweaver.Api/Auth/RunModelProviderSnapshotStore.cs:45-77,83-155; apps/Agentweaver.Api/Runs/RunOrchestrator.cs:796-825; apps/Agentweaver.Api/Auth/RunModelInvocationGuard.cs:11-48; apps/Agentweaver.Api/Runs/RunOrchestrator.cs:826-855
- e4: n4 → n5: Copilot capability. Evidence: apps/Agentweaver.Api/Auth/RunModelInvocationGuard.cs:11-48; apps/Agentweaver.Api/Runs/RunOrchestrator.cs:826-855; apps/Agentweaver.Api/Auth/GitHubCapabilityBroker.cs:35-123; apps/Agentweaver.Api/Sandbox/RunGitHubCapabilityCredentialProvider.cs
