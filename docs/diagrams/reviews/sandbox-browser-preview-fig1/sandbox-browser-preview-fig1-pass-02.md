...
Opened `sandbox-browser-preview-fig1-pass-02.png` (2× official draw.io export) and `sandbox-browser-preview-fig1-pass-02-print.png` (100-units/inch A5 inspection page).
