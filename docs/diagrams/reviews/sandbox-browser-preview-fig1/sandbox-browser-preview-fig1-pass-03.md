...
Opened `sandbox-browser-preview-fig1-pass-03.png` (2× official draw.io export) and `sandbox-browser-preview-fig1-pass-03-print.png` (100-units/inch A5 inspection page).
