...
Remaining orientation defects: 0; overlap/label-legibility defects: 3; arrow defects: 2.

Official UTF-8 XML measurement: 2184 → 26077 (11.940018×), metric `visible-semantic-canonical-xml-v1`. Even excluding all three source/evidence panels, growth remains 10.325092×; no need for those panels, duplicate objects, hidden cells, metadata, embedded-image bytes or off-page padding to meet the gate.
