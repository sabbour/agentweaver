# sandbox-browser-preview-fig1 — pass 06

Corrected one existing source-credit label from preview-gateway.yaml to the repository's gateway-preview.yaml. This is a citation-label typo correction: no new fact, node, connector, layout or visual language. All six arrows traced again.
