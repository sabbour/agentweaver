# sandbox-browser-preview-fig1 — pass 03

Arrow correction only: aligned existing final/initial waypoints exactly with each side port. Existing directions, content and visual language unchanged. Fresh export shows left-facing side arrivals and readable crossings with real bridge arcs.
