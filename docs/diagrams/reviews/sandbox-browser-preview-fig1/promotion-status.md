# sandbox-browser-preview-fig1: review candidate, NOT canonically promoted

## Completed and verified
- Preserved editable pitch and four independently exported/inspected passes. Final candidate: `sandbox-browser-preview-fig1-pass-04.drawio` / `sandbox-browser-preview-fig1-pass-04.png`.
...
- Semantic pass-1 growth: 9.557391×; no invisible, off-page, duplicated or metadata-padding cells.
- Final 6 arrows individually traced in `sandbox-browser-preview-fig1-pass-04.md`; XML endpoints agree with the trace.
...
- No write to `docs/diagrams/src/sandbox-browser-preview-fig1.drawio`, `docs/diagrams/sandbox-browser-preview-fig1.png`, or the stable hash.
