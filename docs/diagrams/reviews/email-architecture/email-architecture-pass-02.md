# email-architecture: pass 02

Mode: correction-only.
Pass 2 corrected the database silhouette and separated A2A/database label positions; pass 3 raised MCP's HTTP connector to a distinct pair of ports clear of the capability/A2A routes.
...
Orientation defects remaining: 0; overlap defects remaining: 1;
arrow defects remaining: 1.
