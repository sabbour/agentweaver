...
Metric: `visible-semantic-canonical-xml-v1`. Baseline **3706**; result **38190**; growth **10.304911×**. No invisible, off-page, duplicate or metadata-padding cells; see `growth.json`.
