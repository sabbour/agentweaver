...
Canonical source: `docs/diagrams/src/canonical-agent-communication-handoff.drawio`.
Stable PNG: `docs/diagrams/canonical-agent-communication-handoff.png`.
...
- `goal`: native:uml — Human goal.
- `spec`: custom:agentweaver — OutcomeSpec.
- `plan`: custom:agentweaver — WorkPlan DAG.
- `a`: custom:agentweaver — Child run A.
- `b`: custom:agentweaver — Child run B.
- `assembly`: custom:agentweaver — Collective assembly.
