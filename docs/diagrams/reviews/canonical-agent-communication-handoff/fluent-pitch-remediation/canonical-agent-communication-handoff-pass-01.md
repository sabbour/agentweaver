# canonical-agent-communication-handoff — pass-01
...
## Meaningful growth
Metric: visible-semantic-canonical-xml-v1; baseline 3623; result 36825; ratio 10.164229×.
...
e1 | goal | spec | draft | evidence direction; intended shape attachment; orthogonal gutter or horizontal activation-to-activation; crossing bridges where required | clean

e2 | spec | plan | confirm | evidence direction; intended shape attachment; orthogonal gutter or horizontal activation-to-activation; crossing bridges where required | clean

e3 | plan | a | dispatch A | evidence direction; intended shape attachment; orthogonal gutter or horizontal activation-to-activation; crossing bridges where required | clean

e4 | plan | b | dispatch B | evidence direction; intended shape attachment; orthogonal gutter or horizontal activation-to-activation; crossing bridges where required | clean

e5 | a | assembly | result A | evidence direction; intended shape attachment; orthogonal gutter or horizontal activation-to-activation; crossing bridges where required | clean

e6 | b | assembly | result B | evidence direction; intended shape attachment; orthogonal gutter or horizontal activation-to-activation; crossing bridges where required | clean
