# Skills: catalog to safe delivery — pitch
...
| active-to-inline | active | inline | no shared FS | apps/Agentweaver.Api/Skills/SkillPromptComposer.cs:108-123 |
| shared-to-inline | shared | inline | write fails | apps/Agentweaver.Api/Skills/SkillPromptComposer.cs:99-106 |
