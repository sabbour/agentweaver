# Skills: catalog to safe delivery — pass-04
...
|---|---|---|---|
| sources-to-catalog: sources → catalog | (0.5, 1) → (0.5, 0) | Direct orthogonal card-to-card gutter | Clean: source departure, target block arrowhead, direction and label agree with evidence above; no unintended join. |
| catalog-to-assign: catalog → assign | (0.5, 1) → (0.5, 0) | Direct orthogonal card-to-card gutter | Clean: source departure, target block arrowhead, direction and label agree with evidence above; no unintended join. |
| assign-to-active: assign → active | (1, 0.5) → (0, 0.5) | (413, 364) → (413, 144) | Clean: source departure, target block arrowhead, direction and label agree with evidence above; no unintended join. |
| active-to-shared: active → shared | (0.5, 1) → (0.5, 0) | Direct orthogonal card-to-card gutter | Clean: source departure, target block arrowhead, direction and label agree with evidence above; no unintended join. |
| shared-to-pointer: shared → pointer | (0.5, 1) → (0.5, 0) | Direct orthogonal card-to-card gutter | Clean: source departure, target block arrowhead, direction and label agree with evidence above; no unintended join. |
| active-to-inline: active → inline | (1, 0.5) → (1, 0.3) | (808, 144) → (808, 455.6) | Clean: source departure, target block arrowhead, direction and label agree with evidence above; no unintended join. |
| shared-to-inline: shared → inline | (0, 0.5) → (0, 0.7) | (438, 254) → (438, 492.4) | Clean: source departure, target block arrowhead, direction and label agree with evidence above; no unintended join. |
