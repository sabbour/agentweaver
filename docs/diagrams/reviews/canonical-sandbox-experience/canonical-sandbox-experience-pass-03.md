# canonical-sandbox-experience — pass-03

Mode: correction-only

## Actual PNG inspection
Opened `canonical-sandbox-experience-pass-03.png` (2× official draw.io export) and `canonical-sandbox-experience-pass-03-print.png` (100-units/inch A5 inspection page).
