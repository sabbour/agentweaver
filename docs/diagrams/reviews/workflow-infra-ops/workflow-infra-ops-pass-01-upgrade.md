...
Metric: `visible-semantic-canonical-xml-v1`. Baseline **4266**; result **40176**; growth **9.417722×**. No invisible, off-page, duplicate or metadata-padding cells; see `growth.json`.
