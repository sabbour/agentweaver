...
Metric: `visible-semantic-canonical-xml-v1`. Baseline **4408**; result **40825**; growth **9.26157×**. No invisible, off-page, duplicate or metadata-padding cells; see `growth.json`.
