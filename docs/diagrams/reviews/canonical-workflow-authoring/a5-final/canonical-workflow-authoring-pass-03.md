# Workflow authoring: pass 03 on true A5

Corrections only: fix the invalid-again endpoint and error-card collision. Actual output inspected at both sizes. Two UML component symbols still extend into their title space.
