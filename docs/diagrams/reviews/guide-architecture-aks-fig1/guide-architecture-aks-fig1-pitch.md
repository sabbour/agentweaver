# AgentHost: bind once, serve ready: pitch review
...
images as truth. Actual `guide-architecture-aks-fig1-pitch.png` and its half-size `-pitch-print.png`
...
is the source. Pass 1 growth: 2335 ->
24136 = 10.336617x; see `growth.json`.
