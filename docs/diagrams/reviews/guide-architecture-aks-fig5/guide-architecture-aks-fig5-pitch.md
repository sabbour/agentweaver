# Credentials: authority stays in the control plane: pitch review
...
images as truth. Actual `guide-architecture-aks-fig5-pitch.png` and its half-size `-pitch-print.png`
...
is the source. Pass 1 growth: 2373 ->
24256 = 10.22166x; see `growth.json`.
