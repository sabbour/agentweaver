      ...
      '/reference/': [
        {
          ...
          items: [
            ...
            { text: 'Live-preview provisioning', link: '/reference/live-preview-provisioning' },
            ...
            { text: 'Project generation model settings', link: '/reference/project-generation-model-settings' },
            { text: 'Project skills', link: '/reference/project-skills' },
      ...
      '/experience/': [
        {
          ...
          items: [
            ...
            { text: 'Live-preview provisioning', link: '/experience/live-preview-provisioning' },
            ...
            { text: 'Transaction traces', link: '/experience/transaction-traces' },
      ...
      '/deep-dive/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Resilient assembly-review loop', link: '/deep-dive/resilient-assembly-review' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Live-preview provisioning', link: '/deep-dive/live-preview-provisioning' },
            ...
            { text: 'Project skills', link: '/deep-dive/project-skills' },
            ...
            { text: 'Project generation model settings', link: '/deep-dive/project-generation-model-settings' },
          ],
        },
        {
          text: 'Data & platform',
