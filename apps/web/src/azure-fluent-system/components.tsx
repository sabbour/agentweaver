...
export function PortalTopNav({
  ...
  return (
    <header className={mergeClasses('azf-portal-topnav', className)}>
      ...
      {(onSearchChange || searchValue != null) && (
        <SearchBox
...
export function PortalRail({ items, ariaLabel = 'Portal rail navigation', className }: PortalRailProps) {
  return (
    <nav className={mergeClasses('azf-portal-rail', className)} aria-label={ariaLabel}>
      {items.map((item) => (
        <Tooltip key={item.id} content={item.label} relationship="label">
          <Button
            ...
            className="azf-portal-rail__button"
...
export function PortalLayout({
  ...
  return (
    <section className={mergeClasses('azf-portal-layout', topNav ? 'azf-portal-layout--with-topnav' : undefined, className)}>
      {topNav}
      <div className={mergeClasses('azf-portal-layout__frame', !rail && 'azf-portal-layout__frame--single-column')}>
        ...
        <div className="azf-portal-layout__content">
          ...
          {commandBar}
          {filters}
          <div className={mergeClasses('azf-portal-layout__body', contentClassName)}>{children}</div>
          {footer}
        </div>
      </div>
    </section>
          ...
          <DialogContent className="azf-stack azf-gap-s azf-delete-dialog__content">
            ...
            {acknowledgement && (
              <Checkbox
                ...
                label={acknowledgement.label as any}
              />
            )}
          </DialogContent>
          <DialogActions>
