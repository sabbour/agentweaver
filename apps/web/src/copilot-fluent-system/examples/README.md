...
For the integrated pattern workbench with broader catalog coverage, see `apps/web/src/copilot-fluent-system/showcase/README.md`.
...
Use `apps/web/src/copilot-fluent-system/showcase/` when you need the full library workbench rather than a single focused sample. The showcase keeps the Azure UI Kit / Fluent 2 pattern language front and center while covering multiple Azure pattern families.
