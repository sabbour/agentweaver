...
export const componentCatalogData: ComponentCatalogData = {
  ...
  "localConsumptionWorkflow": [
    ...
    "Import primitives from apps/web/src/copilot-fluent-system and compose product flows with the checked-in tokens.css contract.",
...
export const patternCatalogData: PatternCatalogData = {
  ...
  "rules": {
    ...
    "libraryRoot": "apps/web/src/copilot-fluent-system",
  ...
  "localConsumptionWorkflow": [
    ...
    "Compose the target flow from apps/web/src/copilot-fluent-system primitives and patterns without assuming Figma MCP exists.",
