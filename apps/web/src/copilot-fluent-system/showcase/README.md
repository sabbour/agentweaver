...
This showcase is the library-local product shell for `apps/web/src/copilot-fluent-system`. It has three primary experiences:
...
```powershell
cd apps/web/src/copilot-fluent-system
