...
export const AUTOMATION_HELP = {
  ...
  autopilotPickup: `${AUTOPILOT_BASE} Also auto-confirms the Outcome plan so pickup runs proceed without waiting for manual confirmation. Applies to runs this project picks up automatically (and their child runs).`,
