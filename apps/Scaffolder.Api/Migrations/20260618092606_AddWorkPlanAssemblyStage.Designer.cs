...
namespace Scaffolder.Api.Migrations
{
    ...
    [Migration("20260618092606_AddWorkPlanAssemblyStage")]
    partial class AddWorkPlanAssemblyStage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Scaffolder.Api.Memory.OutcomeSpec", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Scaffolder.Api.Memory.SteeringDirective", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Scaffolder.Api.Memory.Subtask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Scaffolder.Api.Memory.SubtaskDependency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Scaffolder.Api.Memory.WorkPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Scaffolder.Api.Memory.Subtask", b =>
                {
                    b.HasOne("Scaffolder.Api.Memory.WorkPlan", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Scaffolder.Api.Memory.SubtaskDependency", b =>
                {
                    b.HasOne("Scaffolder.Api.Memory.Subtask", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Scaffolder.Api.Memory.WorkPlan", b =>
                {
                    b.HasOne("Scaffolder.Api.Memory.OutcomeSpec", null)
                        .WithMany()
