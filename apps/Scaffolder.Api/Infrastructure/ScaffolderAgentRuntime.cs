...
/// </summary>
public sealed class ScaffolderAgentRuntime : IAsyncDisposable
{
    ...
    public ScaffolderAgentRuntime(IAgentRunner agentRunner, string workingDirectory, string? modelId = null)
    {
