...
/// The resolved user identity is stored in HttpContext.Items["mcp.user"] and the raw bearer in
/// HttpContext.Items["mcp.bearer_token"] so AgentweaverApiClient forwards the caller's identity.
/// </summary>
