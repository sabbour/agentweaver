...
public sealed class BlueprintTools(AgentweaverApiClient api)
{
    ...
    [McpServerTool(Name = "generate_blueprint"), Description("Generate a new blueprint from a plain-language description using the model. Returns the generated blueprint. Returns 422 if the model output cannot be validated.")]
    public async Task<string> GenerateBlueprintAsync(
        [Description("Plain-language description of the team and workflow to generate a blueprint for (required)")] string description,
