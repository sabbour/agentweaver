...
{
    /// <inheritdoc />
    public partial class PreserveAutomationActivationGuardsAfterProjectGrantKey : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                CREATE TRIGGER IF NOT EXISTS TR_automation_activations_snapshot_insert
                ...
                CREATE TRIGGER IF NOT EXISTS TR_automation_activations_snapshot_immutable
