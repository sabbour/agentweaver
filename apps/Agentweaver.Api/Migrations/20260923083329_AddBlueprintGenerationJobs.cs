    ...
    public partial class AddBlueprintGenerationJobs : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    job_id = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    ...
                    project_id = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    target_repository = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    blueprint_model = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    workflow_model = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    provider_kind = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    provider_type = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    provider_key = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    provider_scope = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    resolution_scope = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    credential_binding_version = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    ...
                    failure_retryable = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    job_id = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    logical_id = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_blueprint_generation_artifacts_blueprint_generation_jobs_job_id",
                        column: x => x.job_id,
