...
public static class AiOperationCatalog
{
    private static readonly IReadOnlyDictionary<string, AiOperationDefinition> Operations =
        new Dictionary<string, AiOperationDefinition>(StringComparer.Ordinal)
        {
            ...
            ["workflow_selection"] = Project("workflow_selection", ProjectRole.Contributor, supportsByok: true),
            ["story_independence_classification"] = Project("story_independence_classification", ProjectRole.Contributor, supportsByok: true),
            ["assembly_gate_classification"] = Project("assembly_gate_classification", ProjectRole.Contributor, supportsByok: true),
