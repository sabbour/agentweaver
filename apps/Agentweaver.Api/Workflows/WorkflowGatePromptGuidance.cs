...
internal static class WorkflowGatePromptGuidance
{
    public const string SoftwareBuildTestRequirement = """
        ...
        followed immediately by exactly one human-review check gate. Neither gate is optional or
        omittable. The build_test gate is static, platform-owned, and always-on; never add an inline
