...
public sealed class AutomationInvocationRecord
{
    ...
    /// <summary>
    /// Server-owned identity reserved before provisional task insertion. It makes staging
    /// retryable without allowing concurrent attempts to manufacture separate tasks.
    /// </summary>
