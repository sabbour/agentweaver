...
public static class EventTypes
{
    ...
    /// Payload: { runId, providerIdentityVersion, state,
    /// providerKind: "byok"|"project_github_copilot"|"platform_github_copilot"|
    /// "user_byok"|"user_github_copilot"|"unavailable", providerType, modelSource, modelId,
    /// providerKey, resolutionScope, providerScope, unavailableReason, timestamp_utc }.
    /// Provider and binding identifiers plus GitHub account metadata are intentionally omitted.
    /// </summary>
