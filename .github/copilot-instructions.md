...
- **[`CONTRIBUTING.md`](../CONTRIBUTING.md) → "AI agent contributions"** — THE canonical
  ...
  per area — use those, don't invent your own. Its **"Branch Topology"** section is the canonical policy for the active
  `dev → release → main` model and future maintenance/queue growth.
