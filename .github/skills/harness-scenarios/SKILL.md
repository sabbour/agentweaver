...
Use this skill when you need scenario discovery or authoring. Use `api-harness`,
`ui-harness`, `mcp-harness`, or `agentweaver-harness` when you are ready to execute
the actual run.
