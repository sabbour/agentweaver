...
| "squad commands", "what can squad do", "show me squad options", "slash commands", "what commands are available" | Read `.copilot/skills/agentweaver-squad-commands/SKILL.md`, present categorized menu (see agentweaver-squad-commands skill) |
