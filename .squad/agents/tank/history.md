...
2026-07-31T03:40:59+03:00 — Publish-apps exploration completed discussion-only. Tank established `publish` as an `open_pull_request`-style workflow node, separated content refresh from code regeneration, and shaped the ACA-style PublishedApp/PublishedAppRevision backend model; OpenAI-compatible v1 was rejected.
